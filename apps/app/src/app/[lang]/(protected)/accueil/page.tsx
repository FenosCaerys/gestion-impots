  ...
  return (
    <PageLayout activeTab={activeTab}>
      ...
      <div className="mx-auto w-full max-w-md lg:mx-auto lg:max-w-6xl">
        {/* En-tête utilisateur */}
        <UserHeader username="Losterne" hasNotification={true} />
        ...
        <div className="flex-1 lg:flex lg:gap-8 lg:p-8">
          ...
          <div className="flex-1 lg:w-2/3">
            ...
            <div className="bg-[#1A1A1A] pb-8 pt-4 lg:mb-8 lg:rounded-xl">
              <TaxCard amount={68574} deadline="15 Sep. 2025" />
            ...
            <div className="pb-4 pt-6 lg:hidden">
              <RecentPaymentsSection items={recentPayments} onViewAllClick={handleViewAllPayments} />
            </div>
          </div>
          ...
          <div className="hidden lg:block lg:w-1/3">
            <div className="rounded-xl bg-white p-6 shadow-sm">
              <h3 className="mb-4 text-lg font-medium text-black">Paiements récents</h3>
            ...
            <div className="mt-6 rounded-xl bg-white p-6 shadow-sm">
              <h3 className="mb-4 text-lg font-medium text-black">Résumé</h3>
