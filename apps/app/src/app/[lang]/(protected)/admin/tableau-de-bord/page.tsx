  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-xl bg-white p-6 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <p className="mb-1 text-sm text-gray-600">Parcelles</p>
        ...
        <div className="rounded-xl bg-white p-6 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <p className="mb-1 text-sm text-gray-600">Taux estimation</p>
        ...
        <div className="rounded-xl bg-white p-6 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <p className="mb-1 text-sm text-gray-600">Detail parcelle</p>
              <p className="text-3xl font-bold text-gray-900">356</p>
            </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        {/* Traffic by Device */}
        <div className="rounded-xl bg-white p-6 shadow-sm">
          <h3 className="mb-6 text-lg font-semibold text-gray-900">Traffic by Device</h3>
          <div className="h-80">
            {/* Bar Chart */}
            <div className="flex h-64 items-end justify-between space-x-4">
              <div className="flex flex-col items-center space-y-2">
                <div className="w-12 rounded-t bg-gray-300" style={{ height: "60px" }}></div>
                <span className="text-xs text-gray-600">Linux</span>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <div className="w-12 rounded-t bg-gray-600" style={{ height: "120px" }}></div>
                <span className="text-xs text-gray-600">Mac</span>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <div className="w-12 rounded-t bg-gray-400" style={{ height: "90px" }}></div>
                <span className="text-xs text-gray-600">iOS</span>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <div className="w-12 rounded-t bg-gray-700" style={{ height: "140px" }}></div>
                <span className="text-xs text-gray-600">Windows</span>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <div className="w-12 rounded-t bg-gray-300" style={{ height: "40px" }}></div>
                <span className="text-xs text-gray-600">Android</span>
              </div>
              <div className="flex flex-col items-center space-y-2">
                <div className="w-12 rounded-t bg-gray-500" style={{ height: "100px" }}></div>
        ...
        {/* Traffic by Location */}
        <div className="rounded-xl bg-white p-6 shadow-sm">
          <h3 className="mb-6 text-lg font-semibold text-gray-900">Traffic by Location</h3>
